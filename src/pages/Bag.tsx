...
export default function Bag() {
  const { bag, updateQuantity, removeFromBag } = useBag();
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
                    ...
                    <div className="flex items-center justify-between mt-4">
                      <div className="flex items-center gap-3">
                        <button
                          ...
                          className="w-8 h-8 border border-border flex items-center justify-center text-foreground hover:border-copper transition-colors"
                        >
            ...
            <div className="lg:col-span-1">
              <div className="bg-card rounded-sm border border-border p-6 sticky top-32">
                ...
                <Link to="/checkout/review" className="block w-full btn-primary text-center">Proceed to Checkout</Link>
